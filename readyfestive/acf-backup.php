    ...
    <div class="">
      <div class="stepwizard" >
          <div class="stepwizard-row setup-panel">
            ...
            <div class="stepwizard-step">
              <a href="#step-2" type="button" class="btn btn-default btn-circle" disabled="disabled" id=secondstep><span>Step 2</span> DECORATING STYLE</a>
            </div>
            <div class="stepwizard-step">
              <a href="#step-3" type="button" class="btn btn-default btn-circle" disabled="disabled" id="thirdstep"><span>Step 3</span> SUBSCRIPTION PREFERENCES</a>
            </div>
            <div class="stepwizard-step hidediv">
              <a href="#step-4" type="button" class="btn btn-default btn-circle" disabled="disabled" id="four-step"><span>Step 3</span> BUILD SUBSCRIPTION</a>
            </div>
          </div>
      </div>
      ...
      <form role="form" action="" method="post">
          ...
          <div class="row setup-content" id="step-3">
             <div class="form-wrapper">
                  ...
                  <div class="col-xs-12 col-md-12 col-md-12">
                      <h4 class="form-sub-hd step-3-hd">Are you looking for more of any certain type of holiday/seasonal products? 
